<?php
	...
	if(isset($_SESSION["user"]))
	{
		...
		$diffurl="http://build.uitdatabank.be/api/events/search?key=AEBA59E1-F80E-4EE2-AE7E-CEDD6A589CA9&thema=".$diffstring."&format=json&pagelength=3&page=".$random;
		...
		$comurl="http://build.uitdatabank.be/api/events/search?key=AEBA59E1-F80E-4EE2-AE7E-CEDD6A589CA9&thema=".$comstring."&format=json&pagelength=3&page=".$random;
