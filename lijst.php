<?php
	...
	if(isset($_SESSION["user"]))
	{
		...
		if($i==""){
			...
			$url="http://build.uitdatabank.be/api/events/search?key=".$g_uitdb_key.$location."&format=json&pagelength=5&page=";
			...
			{
				$urlsingle="http://build.uitdatabank.be/api/event/".$_GET["id"]."?key=".$g_uitdb_key."&format=json";
